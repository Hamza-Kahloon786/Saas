# # app/api/v1/api.py - Add Pipeline Router
...
#     dashboard, notifications, ws, 
#     mobile, customer_portal, realtime, technician_portal,
#     service_requests, technicians, pipeline   # ADD pipeline import here
# )
...
# # ADD THIS LINE - Pipeline Router
# api_router.include_router(pipeline.router, prefix="/pipeline", tags=["pipeline"])
# print("✅ Pipeline router registered successfully")  # ADD THIS DEBUG LINE
