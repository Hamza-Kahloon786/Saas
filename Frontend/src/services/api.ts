// // frontend/src/services/api.ts - UPDATED WITH BETTER ERROR HANDLING
...
// export const USE_FALLBACK = String(import.meta.env.VITE_USE_FALLBACK || 'true').toLowerCase() === 'true'
...
// // ADD THIS INSIDE THE FALLBACK_DATA OBJECT:
...
//     if (USE_FALLBACK && (error.code === 'ECONNABORTED' || error.code === 'ERR_NETWORK' || !response || response.status >= 500)) {
...
//         return cleanUrl.includes(key) || key.includes(cleanUrl)
//       })
